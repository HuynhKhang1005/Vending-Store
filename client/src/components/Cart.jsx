        ...
        {cart && cart?.length > 0 ? (
          <>
            ...
            <div className="bg-zinc-800 rounded-t-[60px] w-full h-[15%] flex flex-col items-center justify-center px-4 py-6 gap-2">
              ...
              <motion.button
                {...buttonClcik}
                className="bg-orange-400 w-[50%] px-4 py-1 text-xl text-headingColor font-semibold hover:bg-orange-500 drop-shadow-md rounded-2xl"
          ...
          <>
            <h1 className="w-full text-3xl text-primary font-bold flex items-center justify-center">Giỏ hàng trống</h1>
          </>
        )}
      </div>
    </motion.div>
