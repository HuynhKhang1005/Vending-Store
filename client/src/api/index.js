...
export const baseURL = "http://127.0.0.1:5001/vending-machine-2511/us-central1/app";
...
export const getAllUsers = async () => {
  try {
    ...
    // Lọc và lấy một người dùng không trùng lặp, ở đây là theo email
    const uniqueUser = removeDuplicates(users, 'email');
...
// Hàm loại bỏ các đối tượng trùng lặp từ mảng dựa trên một thuộc tính
